		  ...
		  <form action="<?= site_url($config->logInFormSubmit)?>" method="post">
			  <table class='table'>
				...
				<tr>
					...
					<td>
						<input type="text" placeholder="Username" name="<?=$config->usernameInputName?>">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="date" name="<?=$config->usernameInputName?>">
					</td>    
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="email" name="<?=$config->usernameInputName?>">
					</td>    
				</tr>     
